        ...
        html.Div(
            ...
            children=[
                html.Div(
                    ...
                    children=[
                        html.A("Thumbnail 1", href="/page1")
                    ]
                ),
                html.Div(
                    className="thumbnail m-2",
                    children=[
                        html.A("Thumbnail 2", href="/page2")
                    ]
                ),
                html.Div(
                    className="thumbnail m-2",
                    children=[
                        html.A("Thumbnail 3", href="/page3")
                    ]
                ),
                html.Div(
                    className="thumbnail m-2",
                    children=[
                        html.A("Thumbnail 4", href="/page4")
                    ]
                ),
                html.Div(
                    className="thumbnail m-2",
                    children=[
                        html.A("Thumbnail 5", href="/page5")
                    ]
                ),
                html.Div(
                    className="thumbnail m-2",
                    children=[
                        html.A("Thumbnail 6", href="/page6")
                    ]
                ),
            ]
        )
